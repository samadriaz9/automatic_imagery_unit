...
Incubation heaters: lower BTS GPIO 12 (pin 32), upper BTS GPIO 26 (pin 37, same duty until target-1 °C then upper only; last 5 min upper only); see incubation_module.py.
